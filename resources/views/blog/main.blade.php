...
<head>
    ...
    @if(config('app.debug') === true)
        <link href="../css/styles.css?v={{config('app.version')}}" rel="stylesheet"/>
        <link href="../css/main.css?v={{config('app.version')}}" rel="stylesheet"/>
        <link href="../css/badge.css?v={{config('app.version')}}" rel="stylesheet"/>
    @else
