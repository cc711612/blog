...
class CharsetBuilder extends BuilderAbstract implements BuilderInterface
{

    protected $BuilderDataBag = [
        'MainAttributeName' => 'charset',
        'Attribute'         => [],
    ];
    ...
    public function __construct(Generator $Generator)
    {
        ...
        // 給予預設值
        //$this->set($this->BuilderDataBag->get('MainAttributeName'), 'utf-8');
    }
    ...
    public function set($MainAttributeValue, $SecondaryAttributeValue, $Arguments = null)
    {
        $this->Attributes->put(
            ...
            $this->Generator->getAttributelist(
                $this->Generator->getAttribute($this->BuilderDataBag->get('MainAttributeName'), $SecondaryAttributeValue)
            )
        );
